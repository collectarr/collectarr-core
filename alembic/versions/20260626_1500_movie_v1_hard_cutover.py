...
Revision ID: 20260626_1500
Revises: 20260626_1401
...
revision: str = "20260626_1500"
down_revision: str | None = "20260626_1401"
...
def upgrade() -> None:
    ...
    if _has_index("movie_releases", "ix_movie_releases_generic_edition_id"):
        op.drop_index("ix_movie_releases_generic_edition_id", table_name="movie_releases")
    if _has_column("movie_releases", "generic_edition_id"):
        _drop_fk_if_exists("movie_releases", ("generic_edition_id",))
        op.drop_column("movie_releases", "generic_edition_id")
...
def downgrade() -> None:
    ...
    if not _has_column("movie_releases", "generic_edition_id"):
        op.add_column(
            "movie_releases",
            sa.Column("generic_edition_id", sa.UUID(), nullable=True),
        )
    if not _has_index("movie_releases", "ix_movie_releases_generic_edition_id"):
        op.create_index(
            "ix_movie_releases_generic_edition_id",
            "movie_releases",
            ["generic_edition_id"],
            unique=False,
        )
