...
DEFAULT_ENTITY_REF_REGISTRY = EntityRefRegistry(
    {
        ...
        "anime_release": EntityRefSpec("anime_release", "anime_releases", "Anime release", kind=ItemKind.anime, supports_links=True, supports_provider_ids=True),
        "anime_episode": EntityRefSpec("anime_episode", "anime_episodes", "Anime episode", kind=ItemKind.anime, supports_links=True, supports_provider_ids=True),
        ...
        "comic_variant": EntityRefSpec("comic_variant", "comic_variants", "Comic variant", kind=ItemKind.comic, supports_links=True, supports_provider_ids=True),
        ...
        "manga_chapter": EntityRefSpec("manga_chapter", "manga_chapters", "Manga chapter", kind=ItemKind.manga, supports_links=True, supports_provider_ids=True),
        ...
        "manga_edition": EntityRefSpec("manga_edition", "manga_editions", "Manga edition", kind=ItemKind.manga, supports_links=True, supports_provider_ids=True),
        ...
        "movie_release": EntityRefSpec("movie_release", "movie_releases", "Movie release", kind=ItemKind.movie, supports_links=True, supports_provider_ids=True),
        "music_release_group": EntityRefSpec("music_release_group", "music_release_groups", "Music release group", kind=ItemKind.music, supports_aliases=True, supports_links=True, supports_provider_ids=True),
        ...
        "music_medium": EntityRefSpec("music_medium", "music_mediums", "Music medium", kind=ItemKind.music, supports_links=True, supports_provider_ids=True),
