...
_KIND_DATA: dict[ItemKind, dict[str, Any]] = {
    ItemKind.comic: {
        ...
        "publishers": ["Marvel Comics", "DC Comics", "Image Comics", "Shueisha", "Kodansha", "Viz Media"],
        "story_arcs": [
            "Clone Saga",
            "Death of Superman",
            "Dark Phoenix Saga",
        ...
        "tags": ["superhero", "action", "sci-fi", "drama", "horror", "shonen", "fantasy", "dark fantasy"],
        "formats": [
            "Single Issue",
            "Trade Paperback",
            "Hardcover",
    ...
    ItemKind.movie: {
        ...
        "tags": ["action", "sci-fi", "psychological", "mecha", "comedy", "thriller", "noir", "adventure"],
        "formats": [
            "Blu-ray",
            "DVD",
            "Blu-ray Box Set",
